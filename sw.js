...
const SHELL = [
  ...
  './js/views/pyq.js', './js/views/progress.js', './js/views/settings.js', './js/views/today.js', './js/views/flashcards.js', './js/views/speed.js', './js/views/tour.js', './js/views/plan.js', './js/views/rank.js', './data/rank-bands.json',
